...
sub resource_classes {
    ...
    return {
        %{$self->SUPER::resource_classes},  # inherit 'default' from the parent class
         ...
         '4Gb_8c_job'   => {'LSF' => '-C0 -M4000  -R"select[mem>4000]  rusage[mem=4000]"  -n 8 span[hosts=1]' },
         '8Gb_job'      => {'LSF' => '-C0 -M8000  -R"select[mem>8000]  rusage[mem=8000]"' },
         '8Gb_8c_job'   => {'LSF' => '-M8000  -R"select[mem>8000]  rusage[mem=8000]"  -n 8 span[hosts=1]' },
         ...
         '512Gb_job'     => {'LSF' => '-M512000 -R"select[mem>512000] rusage[mem=512000]"' },
